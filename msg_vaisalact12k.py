...
class ct12D(MessageDecoder):
    ...
    init_vars.addvar('BS','Backscattered Power','uint16',(250,),'DD')
    init_vars.addvar('STATUS','Ct12k Status information','float32',(25,),'Null')

    # for now we are going to assume height is fixed, and return it as such
    init_fixed_vars = FixedVariableList()
    init_fixed_vars.addvar('HEIGHT','m AGL','int',np.arange(250)*15)
...
vvars = VariableList()
vvars.addvar('BS','Backscattered Power','uint16',(250,),'DD')
vvars.addvar('STATUS','Ct12k Status information','float32',(25,),'Null')
